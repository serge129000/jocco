...
class SmallPremiumComponents extends StatelessWidget {
  ...
  const SmallPremiumComponents(
      {super.key, this.borderColor, required this.data});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        customSheet(context: context, data: data);
      },
      child: Container(
              ...
              child: Align(
                ...
                child: Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .labelSmall!
                      .copyWith(color: PrimaryColors.white, fontSize: 12.5),
                ),
              ),
            )
          ],
